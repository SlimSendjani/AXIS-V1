...
export const TRANSLATIONS: Record<Language, Translation> = {
  fr: {
    ...
    techTitle: "RESTRUCTURATION CORPORELLE",
    ...
    shipping: "LIVRAISON",
    whyUsTitle1: "LIVRAISON 58 WILAYAS",
    whyUsDesc1: "Tout le territoire algérien.",
  ...
  en: {
    ...
    shipping: "SHIPPING",
    whyUsTitle1: "DELIVERY 58 WILAYAS",
    whyUsDesc1: "All Algerian territory.",
  ...
  ar: {
    ...
    shipping: "الشحن",
    whyUsTitle1: "توصيل 58 ولاية",
    whyUsDesc1: "كامل التراب الجزائري.",
  ...
  return [
    {
      ...
      techBadge: "BATCH NO. 04 // MICROFIBRE",
      price: 5900,
      oldPrice: 8500,
    ...
    },
    {
      ...
      techBadge: "BATCH NO. 04 // NEOPRENE 3MM",
      price: 2900,
      oldPrice: 4200,
    ...
    },
    {
      ...
      techBadge: "HIGH-PRESSURE POLYMER",
      price: 2500,
      oldPrice: 3800,
